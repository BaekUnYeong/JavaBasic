...
//자바 프로그램은 하나 이상의 클래스로 구성되어 있고 클래스 안에 데이터와 처리내용을 작성한다.
...
public class ABC {
	...
	public static void main(String[] args) { 
		...
		//예약어(키워드) : 자바에서 사용하는 특별한 기능을 가진 단어
		
		/* 1. 클래스는 변수(데이터)와 메서드(기능)으로 이루어져 있다.
		 * 2. 변수선언을 제외한 모든 문장은 메서드 안에서 작성하단.
		 * 3. 선언이란 내가 사용하고자 하는 것이 무엇인지(클래스, 메서드, 변수 등) 그리고 이름은 무엇인지 컴퓨터에게 알려주는 곳이다.
		 */
		
		//코드는 영문을 사용하기 때문에 영타연습이 필요하다.
		//최소한 200타 이상은 나오도록 연습하자!!(손가락 자리 맞춰서)
	}
