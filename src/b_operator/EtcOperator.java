...
public class EtcOperator {
	...
	public static void main(String[] args) {
		...
		String gd = regNo == 1 ? "남자" : "여자";	
		gd = regNo == 1 ? "남자" : (regNo == 2 ? "여자" : "확인불가");
		System.out.println("당신의 성별은 " + gd + "입니다.");*/
		...
		//문제3. 변수에 저장된 주민등록번호 뒷자리의 첫번재 숫자가 1이나 3이면 남자
		//2나 4이면 여자를 출력해주세요.
		//그외의 숫자를 입력하면 "잘못 입력하셨스니다."를 출력해주세요.
		
		int regNo = 3;
		String gd = regNo == 1 || regNo == 3 ? "남자입니다." : regNo == 2 || regNo == 4 ? "여자입니다." : "잘못 입력하셨습니다.";
		System.out.println("당신의 성별은 " + gd);
	}
}