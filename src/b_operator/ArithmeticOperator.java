...
public class ArithmeticOperator {
	...
	public static void main(String[] args) {
		...
		long e1 = 100000 * 100000; //int와 int의 연산결과는 int이다.
		System.out.println(e1);// 오버플로우 발생
		
		long e2 = 100000 * 100000L;
		//피연산자 중 하나는 long이어야 결과도 long을 얻을 수 있다.
		...
		//정수는 0으로 나눌 수 없다.
//		int g1 = 10/0; //런타임 에러 발생 (컴파일 에러, 런타임 에러 두가지 종류)
		float g2 = 10.0f / 0;
		...
		++i; //전위형(+가 앞에) : 변수가 참조되기 전 수행
		i++; //후위형(+가 뒤에) : 변수가 참조된 후 수행
		...
		//반올림
		//반올림을 하기 위해 0.5를 더하고 소수점을 없애기 위해 int로 형변환
		//double round = 50.5;
		...
		//문제1. 다음을 한줄씩 계산해서 최종 결과값을 출력하시오.
		//1. 123456 + 654321
		//2. 1번의 결과값 * 123456
		//3. 2번의 결과값 / 123456
		//4. 3번의 결과값 - 654321
